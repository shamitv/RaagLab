...
- [x] D03-01 Select and pin YuE2-3B/Vae revisions and license metadata.
- [x] D03-02 Build the isolated Python/CUDA image with hash-locked dependencies.
- [x] D03-03 Acquire weights outside Git and verify immutable file hashes.
