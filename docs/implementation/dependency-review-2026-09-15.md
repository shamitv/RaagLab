...
| Docker Engine | 29.8.0 on reference host | The official 29.8.0 notes include the current 29.x fixes; the release notes also document security fixes in the 29.x line. See [Docker Engine 29 release notes](https://docs.docker.com/engine/release-notes/29/). | Keep host version for this run; recheck before future release. |
